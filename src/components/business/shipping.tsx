const Shipping = () => {
    return (
      <div className="px-10 bg-[#e7e7e7] py-10 space-y-5">
        <h1 className="font-bold text-5xl">Item & Shipping Price List</h1>
        <div className="flex justify-between items-end bg-white p-5">
          <div className="">
            <p className="text-lg">
